...
export class AuthService {
    apiKey = "AIzaSyChAe6EFfZ61lez5bx8ulKX37VnHF6OoGA";
    ...
    private handleError(err: HttpErrorResponse) {
        let errorMes: string = 'An unknown error occured!';
        ...
        switch(err.error.error.message) {
            ...
            case 'OPERATION_NOT_ALLOWED':
                errorMes = 'Password sign-in is disabled for this project.';
                break;
            case 'TOO_MANY_ATTEMPTS_TRY_LATER':
                errorMes = 'We have blocked all requests from this device due to unusual activity. Try again later.';
                break;
            case 'EMAIL_NOT_FOUND':
                errorMes = 'There is no user record corresponding to this identifier. The user may have been deleted.';
                break;
            case 'INVALID_PASSWORD':
                errorMes = 'The password is invalid or the user does not have a password.';
                break;
            case 'USER_DISABLED':
